...
# automatically connects and/or launches calculator process
# returns thread which MUST be joined before program ends
def auto_connect():
    ...
    print("attempting to connect to calculator");
